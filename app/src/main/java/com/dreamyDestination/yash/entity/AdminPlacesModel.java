...
public class AdminPlacesModel extends ArrayList<FeedbackModel>
{
    ...
    public AdminPlacesModel( String feedback_rating , String comment, String posted_by,String posted_on) {
